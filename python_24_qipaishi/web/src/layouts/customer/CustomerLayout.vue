...
const tabs = [
  { name: "customer-stores", label: "首页", icon: "🏠" },
  { name: "customer-orders", label: "订单", icon: "📋" },
  { name: "customer-me", label: "我的", icon: "👤" },
];

const currentTitle = computed(() => route.meta.title ?? "24H 无人棋牌室");
